...
// import CreateSessionModal from '../../CreateSessionModal'
// import SessionDetailModal from '../../SessionDetailModal'
// import { getSessionsByContract, updateSessionStatus, updateSessionNotes } from '@/lib/session-api'
// import { 
//   ArrowLeft,
//   User, 
//   MapPin, 
...
//       const response = await fetch(`${API_URL}/auth/precepteur/contrats`, {
//         headers: {
...
//         const contratTrouve = data.contrats.find((c: any) => String(c.id) === String(contractId))
        
//         if (contratTrouve) {
//           // ✅ Récupérer les sessions via la nouvelle API sessions
//           try {
//             const sessionsData = await getSessionsByContract(Number(contractId))
//             setContract({
//               ...contratTrouve,
//               sessions: sessionsData.sessions || []
//             })
//           } catch (sessionError) {
//             // Si l'API sessions n'est pas encore disponible, utiliser les sessions du contrat
//             console.warn('API sessions non disponible, utilisation des sessions du contrat')
//             setContract(contratTrouve)
//           }
//         } else {
//           setMessage('Contrat introuvable')
//         }
//       } else {
//         setMessage(data.error || 'Erreur lors du chargement du contrat')
//       }
//     } catch (error) {
//       console.error('Erreur chargement contrat:', error)
...
//   // ✅ Changer le statut du contrat via API Express
//   const handleStatusChange = async (newStatus: string) => {
//     if (!contract) return
...
//       const response = await fetch(`${API_URL}/auth/precepteur/contrats/${contract.id}/status`, {
//         method: 'PUT',
//         headers: {
//           'Authorization': `Bearer ${token}`,
//           'Content-Type': 'application/json'
...
//         setTimeout(() => setMessage(''), 3000)
//       } else {
//         setMessage(data.error || 'Erreur lors du changement de statut')
//       }
//     } catch (error) {
//       console.error('Erreur mise à jour contrat:', error)
//       setMessage('Erreur lors du changement de statut')
...
//       // Envoyer l'email
//       await fetch('/api/send-contract-status-email', {
//         method: 'POST',
//         headers: { 'Content-Type': 'application/json' },
//         body: JSON.stringify({
//           to: parentEmail,
...
//         // Notification via API (si disponible)
//         try {
//           await fetch(`${API_URL}/auth/notifications`, {
//             method: 'POST',
//             headers: {
//               'Authorization': `Bearer ${token}`,
//               'Content-Type': 'application/json'
...
//   // ✅ Gérer le changement de statut d'une session via API Express
//   const handleSessionStatusChange = async (sessionId: number, newStatus: string) => {
//     try {
...
//   // ✅ Gérer la mise à jour des notes via API Express
//   const handleNotesUpdate = async (sessionId: number, notes: string) => {
//     try {
