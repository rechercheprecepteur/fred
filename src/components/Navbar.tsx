...
// import { File, LucideLayoutDashboard, Pointer } from 'lucide-react'
...
//     href: '/dashboard',
//     label: 'Dashboard',
//     icon: <File className="w-1 hidden h-4" />,
...
//                 >
//                   {user.photo_profil ? (
//                     <img src={user.photo_profil} alt="Profile" className="w-8 h-8 rounded-full object-cover ring-2 ring-gray-100" />
//                   ) : (
//                     <div className="w-8 h-8 rounded-full bg-gradient-to-br from-gray-300 to-gray-400 flex items-center justify-center text-sm font-medium text-white">
